...
model_classification.add(Dense(units=256,activation = 'relu'))
model_classification.add(Dense(units=6,activation = 'softmax'))
...
#class mode is categorical since 6 things are being classified.

history = model_classification.fit_generator(training_set, steps_per_epoch = 101, epochs = 20, validation_data = testing_set,
                         validation_steps = 300) # steps_per_epoch = Total training images / batch_size, validation_steps = Total testing images
#Graphs
